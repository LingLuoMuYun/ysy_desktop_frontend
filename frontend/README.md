...
- 四栏布局：左侧导航栏（66px）| 对话历史栏（236px，可拖拽调整 220-500px）| 中间工作区 | 右侧面板（354px，可拖拽调整 320-460px）
- 顶部栏：首页显示历史对话/新对话/资源入口，对话标题支持双击或右键重命名；其他模块显示模块名
- 侧边栏可收起/展开（动画过渡）
- 右侧上下文栏：首页显示资源概览，其他模块显示 AI 助手
- 对话历史栏：仅在首页显示，点击顶部"对话历史"按钮展开/关闭，历史条目支持双击/右键重命名
